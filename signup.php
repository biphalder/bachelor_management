...
<div class="container">
    ...
    <form id="signUpForm" name="singUpForm" onsubmit="return submitFunction()" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" id="email" name="email" onblur="email_validation()" placeholder="Enter Email" class="form-control">
            </div>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" id="password" name="password" placeholder="Enter Password" onblur="password_validation()"
                       class="form-control">
            </div>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="password" id="confirmPassword" name="confirmPassword" placeholder="Enter Above Password Again" onblur="confirm_password()"
                       class="form-control">
            </div>
            <div class="col-sm-3">
